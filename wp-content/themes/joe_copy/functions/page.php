...
function add_favicon() { ?>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo esc_url(home_url()); ?>/apple-touch-icon-180x180.png">
    <link rel="icon" type="image/png" href="<?php echo esc_url(home_url()); ?>/favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="<?php echo esc_url(home_url()); ?>/android-chrome-192x192.png" sizes="192x192">
    ...
    <link rel="mask-icon" href="<?php echo esc_url(home_url()); ?>/safari-pinned-tab.svg" color="#5bbad5">
