jQuery(document).ready(function ($) {
    ...
    $('.button-add.carousel').click(function(){
        ...
        $_item.append('<div id="carousel_item_'+$key+'" class="carousel-item"><div class="input-group"><button data-target="#carousel_item_'+$key+'" type="button" class="pull-right button-destroy carousel button button-default button-large"><i class="fa fa-times"></i></button></div><img id="bb_carousel_image_'+$key+'" role="button" class="button-media" data-target="#bb_carousel_image_'+$key+'" data-input="#bb_carousel_image_input_'+$key+'" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="300" height="225"><input id="bb_carousel_image_input_'+$key+'" type="hidden" name="blanket_bootstrap_carousel['+$key+'][image]"><div class="heading-container"><div class="input-group"><i class="input-group-addon fa fa-header text-muted"></i><span class="input-group-addon">Heading</span><input type="text" name="blanket_bootstrap_carousel['+$key+'][heading]"></div></div><div class="subheading-container"><div class="input-group"><i class="input-group-addon fa fa-paragraph text-muted"></i><span class="input-group-addon">Subheading</span><textarea type="text" name="blanket_bootstrap_carousel['+$key+'][subheading]"></textarea><div class="input-group"><span class="input-group-addon">Parent Class</span><input type="text" name="blanket_bootstrap_carousel['+$key+'][subheadingclass]" value=""></div></div></div></div>');
    });
    ...
    //     var $key = $('.section .section-item').length;
    //     var $_item = $('#sections-container');
    //     $_item.append(
    //         '<div id="section_item_'+$key+'" class="section-item flex-container">'
    ...
    //                     + '<input type="text" name="blanket_sections[0][heading]">'
    //                 + '</div>'
    //             + '<div class="form-group">'
    //                 + '<strong>Content</strong>'
    //                 + '<textarea type="text" name="blanket_sections[0][content]"></textarea>'
    //             + '</div>'
    //             + '<div class="caption-container">'
    //                 + '<button type="button" class="button button-destroy section button-default" data-target="#section_item_'+$key+'"><i class="fa fa-close"></i></button>'
    //             + '</div>'
    //         + '</div>'
    //         + '</div>'
    //     );
    ...
    //     $('.section .section-item').each(function(){
    ...
    $('.draggable').draggable({
        ...
        stop: function(event, ui) {
            ...
            $item.each( function(e) {
                ...
                $(this).find('input[id*=bb_carousel_image]').attr('name', 'blanket_bootstrap_carousel['+$key+'][image]');
            });
