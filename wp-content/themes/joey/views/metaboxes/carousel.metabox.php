    ...
    <div class="panel-body">
        ...
        <div id="main-carousel" class="carousel carousel-container">
            <div id="carousel_item_0" class="carousel-item">
                ...
                <input id="bb_carousel_image_input_0" type="hidden" name="blanket_bootstrap_carousel[0][image]" value="<?php echo @$carousels[0]['image'] ?>">
                <div class="heading-container">
                    <div class="input-group">
                        <i class="input-group-addon fa fa-header text-muted"></i>
                        <span class="input-group-addon">Heading</span>
                        <input type="text" name="blanket_bootstrap_carousel[0][heading]" value="<?php echo @$carousels[0]['heading'] ?>">
                    </div>
                </div>
                <div class="subheading-container">
                    <div class="input-group">
                        ...
                        <textarea name="blanket_bootstrap_carousel[0][subheading]"><?php echo @$carousels[0]['subheading'] ?></textarea>
                        <div class="input-group">
                            <span class="input-group-addon">Parent Class</span>
                            <input type="text" name="blanket_bootstrap_carousel[0][subheadingclass]" value="<?php echo @$carousels[0]['subheadingclass'] ?>">
                        </div>
                    </div>
                </div>
            </div><?php
            if( is_array($carousels) || !empty($carousels) ) {
                foreach ($carousels as $key => $value) {
                    ...
                    <div id="carousel_item_<?php echo $key ?>" class="carousel-item">
                        ...
                        <input id="bb_carousel_image_input_<?php echo $key ?>" type="hidden" name="blanket_bootstrap_carousel[<?php echo $key ?>][image]" value="<?php echo $value['image'] ?>">
                        <div class="heading-container">
                            <div class="input-group">
                                <i class="input-group-addon fa fa-header text-muted"></i>
                                <span class="input-group-addon">Heading</span>
                                <input type="text" name="blanket_bootstrap_carousel[<?php echo $key ?>][heading]" value="<?php echo $value['heading'] ?>">
                            </div>
                        </div>
                        <div class="subheading-container">
                            <div class="input-group">
                                <i class="input-group-addon fa fa-paragraph text-muted"></i>
                                <span class="input-group-addon">Subheading</span>
                                <textarea name="blanket_bootstrap_carousel[<?php echo $key ?>][subheading]"><?php echo $value['subheading'] ?></textarea>
                                <div class="input-group">
                                    <span class="input-group-addon">Parent Class</span>
                                    <input type="text" name="blanket_bootstrap_carousel[<?php echo $key ?>][subheadingclass]" value="<?php echo @$carousels[$key]['subheadingclass'] ?>">
                                </div>
                            </div>
                        </div>
                    </div><?php
